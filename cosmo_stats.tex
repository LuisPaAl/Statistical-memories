...
La descripci\'on est\'andar de las propiedades din\'amicas del Universo se basa en la teror\'ia 
...
\begin{figure}[th]
\begin{center}
%\includegraphics[trim =  1mm  1mm 1mm 1mm, clip, width=8.cm, height=5cm]{constraints.png} 
%\includegraphics[trim =  1mm  1mm 1mm 1mm, clip, width=8.cm, height=5cm]{constraints_1.png} 
\end{center}
\caption[Geometries of the spacetime]
{A summary of possible geometries.}
\label{Fig:cmb_sh}
